...
/// \param onError callback when the download fails
///
+ (void)getPlacementWithMode:(NSString * _Nullable)mode placementId:(NSString * _Nonnull)placementId attributes:(NSDictionary<NSString *, id> * _Nullable)attributes campaignId:(NSString * _Nullable)campaignId experienceId:(NSString * _Nullable)experienceId resolveVisitorState:(BOOL)resolveVisitorState onSuccess:(void (^ _Nonnull)(QBPlacementEntity * _Nonnull))onSuccess onError:(void (^ _Nonnull)(NSError * _Nonnull))onError;
